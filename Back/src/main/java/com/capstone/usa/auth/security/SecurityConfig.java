...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://usa-front.s3-website.ap-northeast-2.amazonaws.com", "https://d1q1ozogxmt4db.cloudfront.net", "http://uiseong-ae.kro.kr"));
